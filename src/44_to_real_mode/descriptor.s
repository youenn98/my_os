...
.fp_save:		times 108 + 4 db 0				;FPU前后文保存区域
...
.cs_bit16 :     dq  0x000F9A000000FFFF		    ; CODE (16bit)
.ds_bit16 :     dq  0x000F92000000FFFF			; DATA (16bit)
...
CS_TASK_0		equ	(.cs_task_0 - LDT) | 4		; task0用CS 段寄存器 
DS_TASK_0		equ	(.ds_task_0 - LDT) | 4		; task0用DS	段寄存器
CS_TASK_1		equ	(.cs_task_1 - LDT) | 4 | 3	; task1用CS段寄存器
DS_TASK_1		equ	(.ds_task_1 - LDT) | 4 | 3	; task1用DS段寄存器
CS_TASK_2		equ	(.cs_task_2 - LDT) | 4 | 3	; task2用CS段寄存器
DS_TASK_2		equ	(.ds_task_2 - LDT) | 4 | 3	; task2用DS段寄存器
CS_TASK_3		equ	(.cs_task_3 - LDT) | 4 | 3	; task3用CS段寄存器
DS_TASK_3		equ	(.ds_task_3 - LDT) | 4 | 3	; task3用DS段寄存器
DS_TASK_4		equ	(.ds_task_4 - LDT) | 4 | 3	; task4用DS段寄存器
DS_TASK_5		equ	(.ds_task_5 - LDT) | 4 | 3	; task5用DS段寄存器
DS_TASK_6		equ	(.ds_task_6 - LDT) | 4 | 3	; task6用DS段寄存器
